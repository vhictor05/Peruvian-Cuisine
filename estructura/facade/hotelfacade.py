from estructura.crud.huesped_crud import HuespedCRUD
from estructura.crud.habitacion_crud import HabitacionCRUD
from estructura.crud.reserva_crud import ReservaCRUD
