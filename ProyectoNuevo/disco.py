...
class DiscotecaApp(ctk.CTk):
    ...
    def registrar_evento(self):
        try:
            ...
            # --- VALIDACIÓN: Precios y aforos no negativos ---
            if precio_entrada < 0:
                messagebox.showerror("Error", "El precio de entrada no puede ser negativo.")
                return
            if aforo_maximo < 0:
                messagebox.showerror("Error", "El aforo máximo no puede ser negativo.")
                return
